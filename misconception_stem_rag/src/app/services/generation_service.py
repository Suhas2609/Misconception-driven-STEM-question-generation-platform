        ...
        messages = [
            {
                "role": "system",
                "content": (
                    "You are an expert STEM assessment designer. Provide a single JSON object strictly "
                    "conforming to the supplied schema without additional commentary or markdown."
                ),
            },
