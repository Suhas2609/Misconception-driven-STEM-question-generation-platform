...
def _seed_misconceptions(force: bool = False) -> None:
    global _misconception_cache, _misconceptions_seeded
    ...
    retrieval_service.add_to_chroma(documents, collection_name=_MISCONCEPTION_COLLECTION)
...
def get_related_misconceptions(topic: str, limit: int = 3) -> list[dict[str, Any]]:
    ...
    results = retrieval_service.retrieve_from_chroma(
        topic,
